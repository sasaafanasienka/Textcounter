export const aboutData = {
    ...
    'about-project': {
        ...
        minisubtitle1: '',
        text1: 'Перед вами проект, на примере которого я изучал React, scss и другие технологии. Идея приложения возникла еще на прошлой работе: подсчет количества знаков типичная задача для верстальщика',
        minisubtitle2: 'Технологии:',
        text2: 'HTML, CSS(SCSS), JS, React. React-redux. Axios — для запроса к серверу генерирования "рыбного" текста. React.Router. Также приложение взаимодействует с localStorage',
        minisubtitle3: '',
        text3: '',
        minisubtitle4: '',
        text4: '',
